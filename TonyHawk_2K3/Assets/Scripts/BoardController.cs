...
public class BoardController : MonoBehaviour {
	...
	public float torqueX;	// Modifies forward tilt
	public float torqueZ;	// Modified sideways tilt
	...
	void FixedUpdate () {
		...
		float tiltZ = Input.GetAxis("Mouse Y");

		// Apply tilting torques to the hoverboard
		rigidbody.AddRelativeTorque(tiltZ * torqueZ, 0.0f, tiltX * torqueX);
